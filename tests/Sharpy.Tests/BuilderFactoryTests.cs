...
namespace Sharpy.Tests {
    ...
    internal class BuilderFactoryTests {
        ...
        [Test]
        public void Generator_Is_Not_Null()
        {
            Assert.IsNotNull(BuilderFactory.Generator(b => b));
        }

        [Test]
        public void Generator_Supply_Builder_Is_Not_Null()
        {
            Assert.IsNotNull(new Builder.Builder().Generator(m => m));
        }

        [Test]
        public void Generator_With_Counter_Is_Not_Null()
        {
            Assert.IsNotNull(BuilderFactory.Generator((b, i) => b));
        }
    }
}