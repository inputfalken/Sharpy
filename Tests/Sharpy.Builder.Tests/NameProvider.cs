    ...
    public class NameProvider {
        ...
        public void All_Origins_Are_Supported() {
            ...
            foreach (var value in values)
                Assert.DoesNotThrow(() => {
                    ...
                    Generator.Create(new Sharpy_Builder(configurement)).Select(g => g.FirstName()).Generate();
                });
        }

        [Test]
        public void Female_First_Name_Not_Null_Or_White_Space() {
            var gen = Generator.Create(new Sharpy_Builder());
            //Many
        ...
        public void Origin_Restricted_Constructor_With_One_Country() {
            var swedishNameGenerator =
                Generator.Create(new Sharpy_Builder(new Configurement {NameProvider = new NameByOrigin(Origin.Sweden)}));
        ...
        public void Origin_Restricted_Constructor_With_One_Country_And_One_Region() {
            var svDkGenerator = Generator.Create(new Sharpy_Builder(
                new Configurement {
