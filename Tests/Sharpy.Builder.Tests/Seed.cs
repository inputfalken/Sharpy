...
namespace Tests.Sharpy.Builder.Tests {
    ...
    public class Seed {
        ...
        public void Select_Seed_Bool() {
            var g1 = Generator.Create(new Sharpy_Builder(TestSeed));
            Thread.Sleep(SleepDuration);
            var g2 = Generator.Create(new Sharpy_Builder(TestSeed));
        ...
        public void Select_Seed_SecurityNumber_Formated_False() {
            ...
            var g1 = Generator.Create(new Sharpy_Builder(c1));
            var g2 = Generator.Create(new Sharpy_Builder(c2));
        ...
        public void SelectMany_No_Seed_Bool() {
            var g1 = Generator.Create(new Sharpy_Builder());
            Thread.Sleep(SleepDuration);
            var g2 = Generator.Create(new Sharpy_Builder());
        ...
        public void SelectMany_No_Seed_Integer_No_Arg() {
            var generator = Generator.Create(new Sharpy_Builder());
            Thread.Sleep(SleepDuration);
            var generator2 = Generator.Create(new Sharpy_Builder());
        ...
        public void SelectMany_Seed_Integer_No_Arg() {
            var generator = Generator.Create(new Sharpy_Builder(TestSeed));
            Thread.Sleep(SleepDuration);
            var generator2 = Generator.Create(new Sharpy_Builder(TestSeed));
            var expected = generator2.Select(g => g.Integer()).Take(Count);
            var result = generator.Select(g => g.Integer()).Take(Count);
            Assert.AreEqual(result, expected);
        }
