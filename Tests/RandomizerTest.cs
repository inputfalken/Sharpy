...
namespace Tests {
    ...
    public class RandomizerTest {
        ...
        public void CreateGenerator_CorrectType() {
            var generator = Factory.Generator(randomizer => new TestClass());
        ...
        public void CreateGenerator_Name() {
            var generator = Factory.Generator(randomizer => new TestClass { StringProp = randomizer.Name() }
            );
        ...
        public void CreateGenerator_WithSuppliedList() {
            ...
            var generator = Factory.Generator(randomizer => randomizer.CustomCollection(list));
        ...
        public void CreateGenerator_WithSuppliedArray() {
            ...
            var generator = Factory.Generator(randomizer => randomizer.CustomCollection(items));
        ...
        public void CreateGenerator_UserName() {
            var generator =
                Factory.Generator(randomizer => new TestClass { StringProp = randomizer.UserName() }
                );
        ...
        public void CreateGenerator_Number_OneArg() {
            var generator = Factory.Generator(randomizer => new TestClass { IntProp = randomizer.Number(10) }
            );
        ...
        public void CreateGenerator_Number_TwoArg() {
            var generator =
                Factory.Generator(randomizer => new TestClass { IntProp = randomizer.Number(10, 20) }
                );
        ...
        public void CreateGenerator_Bool() {
            var generator = Factory.Generator(randomizer => new TestClass { BoolProp = randomizer.Bool() }
            );
        ...
        public void CreateGenerator_LocalDateAge() {
            var generator =
                Factory.Generator(randomizer => new TestClass { LocalDateProp = randomizer.DateByAge(10) }
                );
        ...
        public void CreateGenerator_MailAddress_OneArg() {
            var generator =
                Factory.Generator(randomizer => new TestClass { StringProp = randomizer.MailAdress("joby") }
                );
        ...
        public void CreateGenerator_PhoneNumber_Default() {
            var generator = Factory.Generator(randomizer => randomizer.PhoneNumber());
            Assert.IsTrue(generator.Generate(2).All(s => s.Contains("+1") && s.Length == 6));
        }

        [Test]
        public void CreateGenerator_PhoneNumber_Args_Length() {
            var generator = Factory.Generator(randomizer => randomizer.PhoneNumber(length: 5));
        ...
        public void CreateGenerator_PhoneNumber_Args_Prenumber() {
            var generator = Factory.Generator(randomizer => randomizer.PhoneNumber("10"));
        ...
        public void CreateGenerator_PhoneNumber_Args_PreNumber_length() {
            var generator = Factory.Generator(randomizer => randomizer.PhoneNumber("11", 5));
        ...
        public void CreateGenerator_Config_Names() {
            var generator = Factory.Generator(randomizer => randomizer.Name(NameType.MixedFirstName));
        ...
        public void CreateGenerator_Config_UserNames_ByLength5() {
            var generator = Factory.Generator(randomizer => randomizer.UserName());
        ...
        public void CreateGenerator_Config_Names_ByLength5() {
            var generator = Factory.Generator(randomizer => randomizer.Name());
        ...
        public void CreateGenerator_PhoneNumber_Config_Args_PreNumber() {
            var generator = Factory.Generator(randomizer => randomizer.PhoneNumber("11"));
            generator.Config.CountryCode(Country.Norway);
