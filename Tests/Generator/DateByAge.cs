...
namespace Tests.Generator {
    ...
    public class DateByAge {
        ...
        public void Arg_Twenty() {
            var result =
                new Sharpy.Generator(new Configurement(new Random())).Generate(generator => generator.DateByAge(20));
        ...
        public void Arg_Zero() {
            var result =
                new Sharpy.Generator(new Configurement(new Random())).Generate(generator => generator.DateByAge(0));
