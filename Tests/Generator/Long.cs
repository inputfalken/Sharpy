...
namespace Tests.Generator {
    ...
    public class Long {
        ...
        public void NoArgument() {
            var longs = Sharpy.Generator.Create().GenerateSequence(generator => generator.Long(), Length);
        ...
        public void One_Arg_MaxValue() {
            var longs = Sharpy.Generator.Create().GenerateSequence(generator => generator.Long(long.MaxValue),
                Length);
        ...
        public void One_Arg_MinusOne() {
            var longs = Sharpy.Generator.Create().GenerateSequence(generator => generator.Long(-1), Length);
        ...
        public void One_Arg_Thousand() {
            const int max = 1000;
            var longs = Sharpy.Generator.Create().GenerateSequence(generator => generator.Long(max), Length);
        ...
        public void One_Arg_Zero() {
            var longs = Sharpy.Generator.Create().GenerateSequence(generator => generator.Long(0), Length);
            Assert.Throws<ArgumentOutOfRangeException>(() => longs.ToArray());
        ...
        public void Two_Args_MinusThousand_And_MinusTwoThousand() {
            const int min = -1000;
            const int max = -2000;
            var longs = Sharpy.Generator.Create().GenerateSequence(generator => generator.Long(min, max),
                Length);
            Assert.Throws<ArgumentOutOfRangeException>(() => longs.ToArray());
        ...
        public void Two_Args_MinValue_And_Zero() {
            var longs =
                Sharpy.Generator.Create().GenerateSequence(generator => generator.Long(long.MinValue, 0),
                    Length);
            Assert.IsTrue(longs.All(l => l < 0));
        ...
        public void Two_Args_Zero_And_MaxValue() {
            var longs =
                Sharpy.Generator.Create().GenerateSequence(generator => generator.Long(0, long.MaxValue),
                    Length);
            Assert.IsTrue(longs.All(l => l > 0));
