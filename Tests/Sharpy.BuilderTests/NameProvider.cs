    ...
    public class NameProvider {
        ...
        public void All_Origins_Are_Supported() {
            ...
            foreach (var value in values)
                Assert.DoesNotThrow(() => {
                    var configurement = new Configurement() {NameProvider = new NameByOrigin((Origin) value)};
        ...
        public void Origin_Restricted_Constructor_With_One_Country() {
            var swedishNameGenerator =
                Generator.Create(
                    new Builder(new Configurement {NameProvider = new NameByOrigin(Origin.Sweden)}));
