...
namespace GeneratorAPI {
    public static partial class Generator {
        /// <summary>
        ///     <para>
        ///         Provides a set of static methods for creating implementations of <see cref="IGenerator{T}" />.
        ///     </para>
        /// </summary>
        public static class Factory {
            ...
            public static IGenerator<int> Randomizer(int min, int max, int? seed = null) {
                return Create(CreateRandom(seed)).Select(rnd => rnd.Next(min, max));
            }
            ...
            public static IGenerator<int> Randomizer(int max, int? seed = null) {
                return Create(CreateRandom(seed))
